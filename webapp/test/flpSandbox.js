		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Fiori Demo",
									"targetURL": "#teamworknetfioridemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"teamworknetfioridemo-display": {
								"semanticObject": "teamworknetfioridemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=teamwork.net.fioridemo",
									"url": sap.ui.require.toUrl("teamwork/net/fioridemo")
								}
							}
						}
					}
